...
def get_fake_projects() -> list[dict]:
    return [
        {
            "id": 4312,
            "description": None,
        ...
        },
        {
            ...
            "description": None,
            "name": "Doreal Client",
            "name_with_namespace": "Doreal / Doreal Client",
            "path": "doreal-client",
            "path_with_namespace": "doreal/doreal-client",
            "created_at": "2013-09-30T13:46:02Z",
            "default_branch": "main",
            "tag_list": [
                "example",
            ...
            "ssh_url_to_repo": "git@gitlab.example.com:doreal/doreal-client.git",
            "http_url_to_repo": "https://gitlab.example.com/doreal/doreal-client.git",
            "web_url": "https://gitlab.example.com/doreal/doreal-client",
            "avatar_url": "https://gitlab.example.com/uploads/project/avatar/4/uploads/avatar.png",
            "star_count": 412,
            "last_activity_at": "2013-09-30T13:46:02Z",
            "namespace": {
                ...
                "parent_id": None,
                "avatar_url": None,
                "web_url": "https://gitlab.example.com/doreal"
            }
        },
        {
            "id": 213,
            "description": None,
            "name": "mumbasa Client",
            "name_with_namespace": "mumbasa / mumbasa Client",
            "path": "mumbasa-client",
            "path_with_namespace": "mumbasa/mumbasa-client",
            "created_at": "2013-09-30T13:46:02Z",
            "default_branch": "main",
            "tag_list": [
                "example",
            ...
            "ssh_url_to_repo": "git@gitlab.example.com:mumbasa/mumbasa-client.git",
            "http_url_to_repo": "https://gitlab.example.com/mumbasa/mumbasa-client.git",
            "web_url": "https://gitlab.example.com/mumbasa/mumbasa-client",
            "avatar_url": "https://gitlab.example.com/uploads/project/avatar/4/uploads/avatar.png",
            "star_count": 412,
            "last_activity_at": "2013-09-30T13:46:02Z",
            "namespace": {
                ...
                "parent_id": None,
                "avatar_url": None,
                "web_url": "https://gitlab.example.com/mumbasa"
            }
        },
        {
            "id": 21356,
            "description": None,
            "name": "tremblant Client",
            "name_with_namespace": "tremblant / tremblant Client",
            "path": "tremblant-client",
            "path_with_namespace": "tremblant/tremblant-client",
            "created_at": "2013-09-30T13:46:02Z",
            "default_branch": "main",
            "tag_list": [
                "example",
            ...
            "ssh_url_to_repo": "git@gitlab.example.com:tremblant/tremblant-client.git",
            "http_url_to_repo": "https://gitlab.example.com/tremblant/tremblant-client.git",
            "web_url": "https://gitlab.example.com/tremblant/tremblant-client",
            "avatar_url": "https://gitlab.example.com/uploads/project/avatar/4/uploads/avatar.png",
            "star_count": 412,
            "last_activity_at": "2013-09-30T13:46:02Z",
            "namespace": {
                ...
                "parent_id": None,
                "avatar_url": None,
                "web_url": "https://gitlab.example.com/tremblant"
            }
        },
        {
            "id": 7545134123,
            "description": None,
            "name": "chusa Client",
            "name_with_namespace": "chusa / chusa Client",
            "path": "chusa-client",
            "path_with_namespace": "chusa/chusa-client",
            "created_at": "2013-09-30T13:46:02Z",
            "default_branch": "main",
            "tag_list": [
                "example",
            ...
            "ssh_url_to_repo": "git@gitlab.example.com:chusa/chusa-client.git",
            "http_url_to_repo": "https://gitlab.example.com/chusa/chusa-client.git",
            "web_url": "https://gitlab.example.com/chusa/chusa-client",
            "avatar_url": "https://gitlab.example.com/uploads/project/avatar/4/uploads/avatar.png",
            "star_count": 412,
            "last_activity_at": "2013-09-30T13:46:02Z",
            "namespace": {
                ...
                "parent_id": None,
                "avatar_url": None,
                "web_url": "https://gitlab.example.com/chusa"
            }
        },
    ]


def get_fake_languages(id: int):
    frequencies = {
        4312: {
            "Python": 70.69,
            "JavaScript": 20.98,
